...
var Transcript = /** @class */ (function () {
    ...
    Transcript.prototype.getTranscript = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, youtube_1.getYouTubeTranscript)(url)];
                    case 1: 
    ...
    Transcript.prototype.convertTranscriptToCommonFormat = function (transcript) {
        return transcript;
    };
    return Transcript;
}());
